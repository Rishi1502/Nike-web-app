            ...
            <div key={section}>
              ...
              <ul className="mb-10">
                {section.links.map((link)=>(
                  <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-gray-400 cursor-pointer" key={link.name}>
                    <a href="">{link.name}</a>
                  </li>
                ))}
              </ul>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center ">
        <div className="flex flex-1 justify-normal items-center gap-2 font-montserrat cursor-pointer">
          <img 
            ...
            <p>Copytight. All rights reserved.</p>
        </div>
